...
export default function Notification() {
  ...
  return  (<div className={`fixed flex shadow-lg bg-gray-900 space-x-2 h-14 w-max rounded-lg mx-auto bottom-32 items-center justify-center px-10 left-1/2 -translate-x-1/2 transition-transform duration-300 ease-in-out ${showNotification ? "translate-y-full" : "translate-y-[500%]"}`}>
