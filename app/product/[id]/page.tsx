  ...
  return (
    ...
    <div className="flex flex-col items-center py-20">
      ...
      <div className="flex gap-x-4 items-center">
        <Link href="/">
          <button className="flex items-center justify-center gap-x-2 h-10 w-36 rounded text-sm font-bold bg-slate-800 focus:outline-none focus:shadow-outline hover:text-white transition-colors">
