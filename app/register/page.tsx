    ...
    <div className='w-[280px] mx-auto pt-20 flex-col justify-center lg:w-[308px]'>
      ...
      <form className='bg-slate-900 rounded-md p-5 mb-4' autoComplete='off'>
        <div className='mb-4'>
          ...
          <input type="text" className='w-full h-10 rounded-md bg-black px-2 border border-slate-800' autoComplete="none" />
        </div>
        <div className='mb-4'>
        <div className='w-full mb-2'><p>Password</p></div>
          <input type="password" className='w-full h-10 rounded-md bg-black px-2 border border-slate-800' autoComplete="none" />
        </div>
